...
class EnvService {
  ...
  static String get azureDeployment => dotenv.env['AZURE_OPENAI_DEPLOYMENT_NAME'] ?? 'gpt-4.1-mini';
  static String get azureApiVersion => dotenv.env['AZURE_OPENAI_API_VERSION'] ?? '2024-02-15-preview';
  static int get azureMaxTokens => int.parse(dotenv.env['AZURE_MAX_TOKENS'] ?? '4096');
}
